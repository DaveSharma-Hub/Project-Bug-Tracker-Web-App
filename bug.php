...
<div class="w3-sidebar w3-bar-block w3-card w3-animate-left" style="display:none" id="mySidebar">
    ...
    <a href="#" class="w3-bar-item w3-button">Bugs</a>
    ...
    <div class="w3-container">
      ...
      <?php
        ...
        if($stmt_result->num_rows > 0){
            ...
            $stmt = $connection->prepare("select * from bugs where loginID = ?"); //prevent sql injection
...
<div id="bottom">
  ...
  <form action="http://localhost:3000/Users/Daves/Documents/Practice/tracker/addBug.php"  method="post" style="border:1px solid #ccc">
        <div class="container">
          ...
          <input type="text" placeholder="Project ID" name="name" required>
      
          <label for="desc"><b>Bug Description: </b></label>
          <input type="text" placeholder="Bug Description" name="desc" required>
      ...
      <form action="http://localhost:3000/Users/Daves/Documents/Practice/tracker/editBug.php"  method="post" style="border:1px solid #ccc">
        <div class="container">
          <h1>Edit Bug</h1>
          <p>Enter New Project Bug Information Below</p>
          <hr>
      
          <label for="name"><b>Bug ID: </b></label>
          <input type="text" placeholder="Bug ID" name="id" required>
      
          <label for="desc"><b>New Bug Description: </b></label>
          <input type="text" placeholder="New Bug Description" name="desc" required>
      ...
      <form action="http://localhost:3000/Users/Daves/Documents/Practice/tracker/deleteBug.php"  method="post" style="border:1px solid #ccc">
        <div class="container">
          <h1>Delete Bug</h1>
          <p>Delete Bug</p>
          <hr>
